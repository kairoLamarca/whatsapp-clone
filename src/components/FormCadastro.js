...
import { modificaEmail, modificaSenha } from '../actions/AutenticacaoActions';//Action Creators
...
export default connect(mapStateToPros, { modificaEmail, modificaSenha })(formCadastro);
