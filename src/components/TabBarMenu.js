        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
            ...
            <View style={{ flexDirection: 'row', marginRight: 20 }}>
                <View style={{ justifyContent: 'center', width: 50, alignItems: 'center' }}>
                    <TouchableHighlight
                        //faz a chamada de duas funções, uma para a rota, e outra para limpar a tela
                        //Quando cadastrava alguem e depois voltava pra tela, continuava a msg de sucesso
